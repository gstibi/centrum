...
import mladi1 from '../assets/images/mladi1.webp';
import mladi2 from '../assets/images/mladi2.webp';
import mladi3 from '../assets/images/mladi3.webp';
...
const smallDisplay = window.matchMedia('(max-width: 900px)').matches;
  ...
  >
    {!smallDisplay && (
      <>
        ...
        >
          <Box
            sx={{ height: '50vh', overflow: 'hidden', position: 'relative' }}
          >
            <ImageBox
              width="15%"
              left="5%"
    ...
    {smallDisplay && (
      <Box
        sx={{
          backgroundImage: `url(${pristavbaVpredu})`,
          backgroundSize: 'cover',
